...
Usage:
    APIFY_TOKEN=apify_api_... MAX_PLACES_PER_QUERY=100 python scripts/scrape_google_maps.py
"""
import os
import sys
import json
...
async def main():
    ...
    if not apify_token:
        ...
        print("Usage: APIFY_TOKEN=apify_api_XXXXXX python scripts/scrape_google_maps.py")
        sys.exit(1)
